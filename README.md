...
docs/01_Positive_Expectancy_and_Risk_Constraints/Market_Impact_Cost.md
...
### Market_Impact_Cost.md

解释“冲击成本”的含义，以及它和手续费、滑点、买卖价差、`EstimatedRoundTripCostPerLot`、`TradeR` 的关系。
